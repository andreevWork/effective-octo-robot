...
/* package effective-octo-robot-0.1.0.0 */
#define VERSION_effective_octo_robot "0.1.0.0"
#define MIN_VERSION_effective_octo_robot(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "effective-octo-robot-0.1.0.0-KcrcswkT73U2JfS8YKFcKm"

#define CURRENT_PACKAGE_KEY "effective-octo-robot-0.1.0.0-KcrcswkT73U2JfS8YKFcKm"
